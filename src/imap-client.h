...
static const struct imap_capability_name cap_names[] = {{"LITERAL+", CAP_LITERALPLUS},
...
int imap_client_input_error(struct imap_client *client, const char *fmt, ...) ATTR_FORMAT(2, 3);
int imap_client_input_warn(struct imap_client *client, const char *fmt, ...) ATTR_FORMAT(2, 3);
int imap_client_state_error(struct imap_client *client, const char *fmt, ...) ATTR_FORMAT(2, 3);
